...
public class RedKingPiece extends GamePiece
{
	public RedKingPiece (int row, int col) {
		super (row, col, Player.RED);
	}

	public RedKingPiece (Position pos) {
		this (pos.r, pos.c);
	}
	...
	public void drawPiece (Graphics2D g2, int x, int y, int width, int height)
	{
		...
		ImageIcon imageIcon = new ImageIcon("Red_Crown_large.png"); // load the image to a imageIcon
